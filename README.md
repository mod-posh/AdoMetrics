...
Enclosed are the files I use to build and deploy PowerShell script modules composed of multiple Nested PowerShell modules. The basic file structure is included so you know what it should look like. Several Modules are required, and the Tasks will check for them at the start.
